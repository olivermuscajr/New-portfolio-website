...
if (!GEMINI_API_KEY) {
  ...
  console.warn(
    "[Gemini] Missing VITE_GEMINI_API_KEY. Using fallback responses."
  );
}
...
- Tools: Git, npm, GitHub, Node.js, Express, React Router
...
- MealKit: A meal planner mobile application using Kotlin and Android Studio
- Weather Dashboard: Responsive weather app with interactive maps
- Record Management System: A Java-based project that includes CRUD operation with MySQL

**Education & Learning:**
- Graduated BSIT at Romblon State University
...
- Interested in frontend or full-stack development opportunities
...
- Adaptive and continuous learner
